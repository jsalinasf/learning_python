...
class Coin:
    ...
    def __str__(self):
        if self.original_value >= 1:
            ...
            return "{} Cents".format(int(self.original_value * 100))
...
class Five_Pence(Coin):
    ...
    def __init__(self):
        data ={
            "original_value" : 0.05,
            "clean_color" : "silver",
            "rusty_color" : None, #OJO AQUI needs overwirte cuz it doesn't rust
            "num_edges" : 1,
            "diameter" : 18.0,
            "thickness" : 1.77,
            "mass" : 3.25
...
for coin in coins:
    ...
    string = "{} - Color: {}, Value: {}, Diameter(mm): {}, Thickness (mm): {}, Edges: {}, Mass: {}".format(*arguments)
    print(string)
